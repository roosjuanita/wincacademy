// Ignore this for now
const { randomPersonData } = require("./data.js");
const {getCurrentDate, transformDateOfBirth, calculateAge} = require("./dates.js");
const {dateToZodiac, zodiacSignsMatch} = require("./zodiac.js");
