// Ignore this for now
// const randomPersonData = require("./data.js")['randomPersonData']; //CommonJS export syntax
import { randomPersonData } from './data.js'; //ECMAScript Module (ESM) style
import { getCurrentDate, transformDateOfBirth, calculateAge} from './dates.js';
import { zodiacSignsMatch, dateToZodiac} from './zodiac.js';
